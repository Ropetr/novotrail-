...
export function PeriodFilter() {
  ...
  const displayText = startDate && endDate
    ...
    : presets.find(p => p.value === selectedPreset)?.label || "Últimos 30 dias"

  return (
    <Popover open={isOpen} onOpenChange={setIsOpen} modal={false}>
      <PopoverTrigger asChild>
        <Button variant="outline" className="h-8 text-sm bg-background gap-2 font-normal w-[200px] justify-start">
