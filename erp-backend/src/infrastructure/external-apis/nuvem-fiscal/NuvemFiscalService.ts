...
} from '../../../domain/entities/nuvem-fiscal/NuvemFiscalTypes';
import { NuvemFiscalClient } from './NuvemFiscalClient';

/**
 * Serviço principal da API Nuvem Fiscal
 * Centraliza todas as operações disponíveis
 */
export class NuvemFiscalService {
  ...
  /**
   * Lista todas as empresas associadas à conta
   */
   ...
   * ATENÇÃO: Campos não informados serão apagados (PUT)
   */
  ...
  /**
   * Lista todos os certificados associados à conta
   */
