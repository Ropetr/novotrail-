import { OAuth2Config, ApiResponse, NuvemFiscalError } from '../../../domain/entities/nuvem-fiscal/NuvemFiscalTypes';
import { NuvemFiscalAuthService } from './NuvemFiscalAuthService';
...
export class NuvemFiscalClient {
  ...
  private async request<T>(
    ...
    try {
      ...
      console.error(`[NUVEM_FISCAL] Erro na requisição ${method} ${endpoint}:`, error);
      return {
        success: false,
