...
export const empresaSchema = z.object({
  cpf_cnpj: z.string().min(11).max(14, 'CPF/CNPJ inválido'),
  inscricao_estadual: z.string().max(50).optional(),
  inscricao_municipal: z.string().max(50).optional(),
  nome_razao_social: z.string().min(1).max(500, 'Nome/Razão Social é obrigatório'),
...
// ============================================
// SCHEMAS DE VALIDAÇÃO - CERTIFICADO
// ============================================

export const cadastrarCertificadoBase64Schema = z.object({
  certificado: z.string().min(1, 'Certificado (base64) é obrigatório'),
...
// ============================================
// SCHEMAS DE VALIDAÇÃO - CNPJ
// ============================================

export const consultarCNPJSchema = z.object({
  cnpj: z.string().min(11).max(18, 'CNPJ inválido'),
});
